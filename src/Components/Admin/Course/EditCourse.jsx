  ...
  return (
    ...
    >
      <div className="flex justify-between mb-3">
        <h2 className="text-xl font-semibold text-center">Edit Course</h2>
        <button
          type="submit"
          className="bg-gradient-to-r from-green-500 to-green-600 text-white px-5 py-2 rounded hover:from-green-600 hover:to-green-700 focus:outline-none focus:shadow-outline-green active:bg-green-800 transition duration-300"
        >
          Update Course
        </button>
      </div>
